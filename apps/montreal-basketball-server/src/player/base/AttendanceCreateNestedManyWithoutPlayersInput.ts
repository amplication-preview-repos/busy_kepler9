...
@InputType()
class AttendanceCreateNestedManyWithoutPlayersInput {
...
export { AttendanceCreateNestedManyWithoutPlayersInput as AttendanceCreateNestedManyWithoutPlayersInput };
